...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        ############################################################################
        C, H, W = input_dim
        self.params.update({'W1':np.random.normal(0.0, weight_scale, [num_filters, C, filter_size, filter_size]), \
                            'W2':np.random.normal(0.0, weight_scale, [num_filters * H * W // 4, hidden_dim]), \
