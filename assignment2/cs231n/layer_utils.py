...
def affine_batchnorm_relu_forward(x, w, b, gamma, beta, bn_params):
    ...
    Inputs:
    - x, w, b: same as affine_relu_forword
    - gamma, beta: batch norm
    - bn_params
    
    Returns a tuple of:
    - out: Output from the final ReLu layer
    - cache: Object to give to the backward pass
    """
...
def affine_batchnorm_relu_backward(dout, cache):
    """
    Backward pass for the affine-batchnorm_ReLU convenience layer
    """
    fc_cache, bn_cache, relu_cache = cache
    dx = relu_backward(dout, relu_cache)
    dx, dgamma, dbeta = batchnorm_backward_alt(dx, bn_cache) #batchnorm_backward(dx, bn_cache)
